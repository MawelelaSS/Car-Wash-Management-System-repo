 ...
 * @author sibus
 */
public class SaveMaleCustomersSummaryToFile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        File file = new File("Male Customers Details.txt");
        file.createNewFile();
        ...
        request.getRequestDispatcher("saving_male_customer_details_to_file_outcomes.jsp").forward(request, response);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SaveMaleCustomersSummaryToFile</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SaveMaleCustomersSummaryToFile at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
