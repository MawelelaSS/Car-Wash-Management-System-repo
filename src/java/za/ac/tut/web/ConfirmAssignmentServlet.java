 ...
 * @author sibus
 */
public class ConfirmAssignmentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        empManager.edit(employee);
        int appointSize = appointments.size();
        request.setAttribute("size", appointSize);
        request.setAttribute("employee", employee);
        request.getRequestDispatcher("assigning_outcomes.jsp").forward(request, response);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConfirmAssignmentServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConfirmAssignmentServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
