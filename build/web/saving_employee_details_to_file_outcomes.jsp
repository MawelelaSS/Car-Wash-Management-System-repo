<%-- 
    Document   : saving_employee_details_to_file_outcomes
    Created on : May 14, 2024, 2:13:11 PM
    Author     : sibus
--%>
...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td>you successfully save employees details to a text file please check absolute path <b><%=file.getAbsolutePath()%></b></td>
            </tr>
            <tr>
