<%-- 
    Document   : saving_male_customer_details_to_file_outcomes
    Created on : May 16, 2024, 12:56:20 PM
    Author     : sibus
--%>
...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td>Hey you successfully save male details to a text file please check absolute path <b><%=file.getAbsolutePath()%></b></td>
            </tr>
            <tr>
