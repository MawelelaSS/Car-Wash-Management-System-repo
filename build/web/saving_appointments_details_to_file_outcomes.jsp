<%-- 
    Document   : saving_appointments_details_to_file_outcomes
    Created on : May 14, 2024, 2:39:18 PM
    Author     : sibus
--%>
...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td>you successfully save your appointments details to a text file please check absolute path <b><%=file.getAbsolutePath()%></b></td>
            </tr>
            <tr>
                <td>Click <a href="admin_login_outcome.jsp">here</a> to go to menu OR <a href="index.html">here</a> to Logout</td>
            </tr>
