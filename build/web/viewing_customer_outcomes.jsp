<%-- 
    Document   : viewing_customer_outcomes
    Created on : May 15, 2024, 9:29:14 AM
    Author     : sibus
--%>
    ...
    <body>
        ...
        <div class="scrollable-table-container">
            <table>
                ...
                <tr>
                    <td><a href="admin_login_outcome.jsp"><input type="button" value="VIEW MENU"></a>     <a href="index.html"><input type="button" value="LOGOUT"></a></td>
                </tr>
