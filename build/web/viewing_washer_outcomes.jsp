<%-- 
    Document   : viewing_washer_outcomes
    Created on : May 16, 2024, 11:30:03 AM
    Author     : sibus
--%>
...
<html>
    <head>
        ...
        <title>viewing_washer_outcomes Page</title>
                <style>
            body {
    ...
    <body>
        ...
        <table align="center">
            ...
            <%}%>
             <tr>
                    <td><a href="SaveCarWasherEmployeesDetailsFile.do"><input type="button" value="SAVE TO TXT FILE"></a> <a href="admin_login_outcome.jsp"><input type="button" value="VIEW MENU"></a>     <a href="index.html"><input type="button" value="LOGOUT"></a></td>
                </tr>
        </table>
