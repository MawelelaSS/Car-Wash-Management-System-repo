<%-- 
    Document   : viewing_male_customer_outcomes
    Created on : May 16, 2024, 11:01:23 AM
    Author     : sibus
--%>
...
<html>
    ...
    <body>
        ...
        <div class="scrollable-table-container">
            <table>
                <tr>
                    <td><h1>Male Customers Details</h1></td>
                ...
                <tr>
                    <td><a href="SaveMaleCustomersSummaryToFile.do"><input type="button" value="SAVE TO TXT FILE"></a> <a href="admin_login_outcome.jsp"><input type="button" value="VIEW MENU"></a>     <a href="index.html"><input type="button" value="LOGOUT"></a></td>
                </tr>
