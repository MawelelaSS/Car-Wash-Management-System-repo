<%-- 
    Document   : saving_female_customer_details_to_file_outcomes
    Created on : May 16, 2024, 12:35:12 PM
    Author     : sibus
--%>
...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td>Hey you successfully save female details to a text file please check absolute path <b><%=file.getAbsolutePath()%></b></td>
            </tr>
            <tr>
